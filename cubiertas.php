        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="text-justify">Texto de Cubiertas. Texto de Cubiertas. Texto de Cubiertas. Texto de Cubiertas. Texto de Cubiertas.</p>
                    <p class="text-justify">Texto de Cubiertas. Texto de Cubiertas. Texto de Cubiertas. Texto de Cubiertas. Texto de Cubiertas.</p>
                    ...
                    <amp-carousel on="slideChange:AMP.setState({carousel: {selectedSlide:event.index}})"
                        ...
                        <?php
                            $ruta_de_las_imagenes_de_la_galeria = 'images/servicios/cubiertas/';
