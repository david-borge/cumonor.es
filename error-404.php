<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Error 404 - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="Error 404 en la web de Cumonor.">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/error-404.php">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-center">Hubo un error 404. La página que buscabas no existe.</p>
