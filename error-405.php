<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Error 405 - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="Error 405 en la web de Cumonor.">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/error-405.php">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-center">Hubo un error 405. Método no permitido por el servidor.</p>
