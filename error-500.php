<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Error 500 - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="Error 500 en la web de Cumonor.">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/error-500.php">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-center">Hubo un error 500. Error del servidor.</p>
