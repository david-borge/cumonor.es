<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Error - No se pudo enviar el mensaje - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="Error al enviar un mensaje en la web de Cumonor.">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/error.php">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        ...
                        <p class="text-center">No se pudo enviar el mensaje.</p>
                        
                        <p class="text-center">
                            <script>
                                document.write('<a href="' + document.referrer + '">Volver a intentarlo</a>');
                            </script>
