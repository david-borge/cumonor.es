<?php include 'head-tag-start.php';?>


  <!-- Título de esta página -->
  <title>Limpieza y Mantenimiento de Naves Industriales | Cumonor - Cubiertas y Montajes Norte s.l.</title>
  ...
  <!-- Referencias:
          ...
          · 
  -->
  <!-- TODO: REVVISAR DATOS DE image Y PONER BREADCRUMB, CAROUSEL, FAQ, IMAGE LICENSE METADATA, LOCAL BUSINESS, LOGO y PRODUCT. -->
  ...
  *,
  ...
  #sidebar1 .dropdown-item:focus,
  #sidebar1 .dropdown-item:hover {
      color: #3c2a96d9;
      text-decoration: none;
      font-weight: bold
  }

  #sidebar1 .dropdown-item.active,
  #sidebar1 .dropdown-item:active {
      color: #3c2a96d9;
      text-decoration: none;
      font-weight: bold
...
<?php include 'head-tag-end.php';?>




<?php include 'navbar-y-sidebar.php';?>
