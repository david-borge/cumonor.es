<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <link rel="canonical" href="https://cumonor.es/limpieza-y-mantenimiento-de-viviendas.php">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <amp-carousel on="slideChange:AMP.setState({carousel: {selectedSlide:event.index}})"
                        ...
                        <?php
                            $ruta_de_las_imagenes_de_la_galeria = 'images/servicios/limpieza-y-mantenimiento-de-viviendas/';
