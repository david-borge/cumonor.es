<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Naves Agrícolas - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="FALTA">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/naves-agricolas.php">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="text-justify">Texto de Naves Agrícolas. Texto de Naves Agrícolas. Texto de Naves Agrícolas. Texto de Naves Agrícolas. Texto de Naves Agrícolas.</p>
                    <p class="text-justify">Texto de Naves Agrícolas. Texto de Naves Agrícolas. Texto de Naves Agrícolas. Texto de Naves Agrícolas. Texto de Naves Agrícolas.</p>
                    ...
                    <amp-carousel on="slideChange:AMP.setState({carousel: {selectedSlide:event.index}})"
                        ...
                        <?php
                            $ruta_de_las_imagenes_de_la_galeria = 'images/servicios/naves-agricolas/';
