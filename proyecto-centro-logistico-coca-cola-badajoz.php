<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Centro logístico Coca-Cola (Badajoz) - Proyectos realizados - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="FALTA">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/proyecto-centro-logistico-coca-cola-badajoz.php">
            ...
            <div id="welcome-blurb">
                <div class="row">
                    <div class="col-12">
                        ...
                        <h1>Centro logístico Coca-Cola</h1>
