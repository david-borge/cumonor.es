<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Galletas Gullón (¿Ubicación?) - Proyectos realizados - Cumonor</title>
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-12 col-md-9">
                    ...
                    <amp-carousel on="slideChange:AMP.setState({carousel: {selectedSlide:event.index}})"
                        ...
                        <?php
                            $ruta_de_las_imagenes_de_la_galeria = 'images/proyectos-realizados/galletas-gullon-ubicacion/';
