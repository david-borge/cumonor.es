<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Pista de Frontón (Aleamayor, Valladolid) - Proyectos realizados - Cumonor</title>

    <!-- Description de esta página -->
    <meta name="description" content="FALTA">

    <!-- URL canónica de esta página -->
    <link rel="canonical" href="https://cumonor.es/proyecto-galletas-gullon-ubicacion.php">
            ...
            <div class="row justify-content-center mt-5">
                <div class="col-12 col-md-9">
                    ...
                    <amp-carousel on="slideChange:AMP.setState({carousel: {selectedSlide:event.index}})"
                        ...
                        <?php
                            $ruta_de_las_imagenes_de_la_galeria = 'images/proyectos-realizados/pista-de-fronton-aleamayor-valladolid/';
