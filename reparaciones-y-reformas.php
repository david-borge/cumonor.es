<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Reparaciones y reformas - Cumonor</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="text-justify">Texto de Reparaciones y reformas. Texto de Reparaciones y reformas. Texto de Reparaciones y reformas. Texto de Reparaciones y reformas. Texto de Reparaciones y reformas.</p>
                    <p class="text-justify">Texto de Reparaciones y reformas. Texto de Reparaciones y reformas. Texto de Reparaciones y reformas. Texto de Reparaciones y reformas. Texto de Reparaciones y reformas.</p>
                    ...
                    <amp-carousel on="slideChange:AMP.setState({carousel: {selectedSlide:event.index}})"
                        ...
                        <?php
                            $ruta_de_las_imagenes_de_la_galeria = 'images/servicios/reparaciones/';
