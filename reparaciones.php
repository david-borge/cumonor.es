<?php include 'include/html-and-head-tags-start.php';?>
    ...
    <title>Reparaciones - Cumonor</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <p class="text-justify">Texto de Reparaciones. Texto de Reparaciones. Texto de Reparaciones. Texto de Reparaciones. Texto de Reparaciones.</p>
                    <p class="text-justify">Texto de Reparaciones. Texto de Reparaciones. Texto de Reparaciones. Texto de Reparaciones. Texto de Reparaciones.</p>
